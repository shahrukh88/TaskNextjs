...
function HomePage(props) {
  ...
  /*#__PURE__*/
  Object(jsx_runtime_["jsxs"])(react_production_min_["Fragment"], {
...
async function getStaticProps() {
  // fetch data from an API
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://shahrukh:shahrukh@cluster0.dd3uo.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
